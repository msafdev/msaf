  ...
  return (
    <div className="relative flex overflow-hidden rounded-md border bg-popover">
      <div className="animate-marquee grid grid-cols-6 items-center whitespace-nowrap py-12">
        <Image src={Facebook} className="px-4" alt="Facebook" />
        <Image src={Amazon} className="px-4" alt="Amazon" />
        <Image src={Netflix} className="px-4" alt="Netflix" />
        <Image src={Google} className="px-4" alt="Google" />
        <Image src={Nike} className="px-4" alt="Nike" />
        <Image src={Microsoft} className="px-4" alt="Microsoft" />
      </div>
