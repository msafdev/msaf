...
const CardThree = () => {
  return (
    <div className="flex w-fit flex-col rounded-md border bg-popover px-5 py-4">
      <div className="flex w-full items-center justify-between gap-x-6 md:gap-x-12 lg:gap-x-18">
      ...
      <div className="mt-4 flex items-center gap-x-3">
        <h3 className="text-sm md:text-base font-medium text-foreground">Google</h3>
      ...
      <p className="md:mt-1 text-xs text-muted-foreground">Mountain View, CA</p>
